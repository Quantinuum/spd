...
from tests.helpers import make_initial_spo
...
def test_openqasm_ir_single_qubit_rx_z_expectation(backend_name):
    ...
    final_spo = spd.evolve(initial_spo, operations, trunc_val=1e-12, max_num_str=1000)
...
def test_openqasm_ir_backward_single_parameter_gradient(backend_name):
    ...
    backward_final_spo, grads = spd.backpropagate(
        initial_spgo,
        operations,
        trunc_val=1e-12,
        max_num_str=1000,
